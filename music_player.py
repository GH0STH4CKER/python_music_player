...
img0 = Image.open(r"C:\Users\Dimuth De Zoysa\Downloads\oie_trans.gif")
img0 = img0.resize((256,256), Image.ANTIALIAS)
coverart = ImageTk.PhotoImage(img0)

img1 = Image.open(r"C:\Users\Dimuth De Zoysa\Downloads\button_black_play.png")
img1 = img1.resize((66,66), Image.ANTIALIAS)
play_icon = ImageTk.PhotoImage(img1)

img2 = Image.open(r"C:\Users\Dimuth De Zoysa\Downloads\button_black_stop.png")
img2 = img2.resize((50,50), Image.ANTIALIAS)
stop_icon = ImageTk.PhotoImage(img2)

img3 = Image.open(r"C:\Users\Dimuth De Zoysa\Downloads\button_black_pause.png")
img3 = img3.resize((66,66), Image.ANTIALIAS)
pause_icon = ImageTk.PhotoImage(img3)

img4 = Image.open(r"C:\Users\Dimuth De Zoysa\Downloads\button_black_previous.png")
img4 = img4.resize((50,50), Image.ANTIALIAS)
prev_icon = ImageTk.PhotoImage(img4)

img5 = Image.open(r"C:\Users\Dimuth De Zoysa\Downloads\button_black_next.png")
img5 = img5.resize((50,50), Image.ANTIALIAS)
next_icon = ImageTk.PhotoImage(img5)

img6 = Image.open(r"C:\Users\Dimuth De Zoysa\Downloads\button_black_load.png")
...
def dbl_click(event) :
    ...
    lbl.unload()
    if newimg is None :
        lbl.load(r'C:\Users\Dimuth De Zoysa\Downloads\mp3animtion256.gif')
    else :
        lbl['image'] = newimg
...
def play():  # Play/Pause/Unpause song
    ...
    if n == 1 :  # Play if clicked on start
        ...
        lbl.unload() 
        if newimg is None :
            lbl.load(r'C:\Users\Dimuth De Zoysa\Downloads\mp3fixed256.gif')
        else :
            lbl['image'] = newimg
        status = 'PAUSED'
